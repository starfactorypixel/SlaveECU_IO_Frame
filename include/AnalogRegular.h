...
namespace Analog
{
	...
	static constexpr regular_channel_t channels[] = 
	{
		...
		{GPIOA, GPIO_PIN_1, ADC_CHANNEL_1, ADC_REGULAR_RANK_2},
		{GPIOA, GPIO_PIN_2, ADC_CHANNEL_2, ADC_REGULAR_RANK_3},
		{GPIOA, GPIO_PIN_3, ADC_CHANNEL_3, ADC_REGULAR_RANK_4},
		{GPIOA, GPIO_PIN_4, ADC_CHANNEL_4, ADC_REGULAR_RANK_5},
		{GPIOA, GPIO_PIN_5, ADC_CHANNEL_5, ADC_REGULAR_RANK_6},
		{GPIOA, GPIO_PIN_6, ADC_CHANNEL_6, ADC_REGULAR_RANK_7},
		{GPIOA, GPIO_PIN_7, ADC_CHANNEL_7, ADC_REGULAR_RANK_8},
		{GPIOB, GPIO_PIN_0, ADC_CHANNEL_8, ADC_REGULAR_RANK_9}
	};
